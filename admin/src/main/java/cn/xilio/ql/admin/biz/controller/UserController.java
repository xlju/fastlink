package cn.xilio.ql.admin.biz.controller;

import cn.hutool.core.util.StrUtil;


import cn.xilio.ql.admin.biz.service.UserService;
import cn.xilio.ql.admin.common.base.BaseController;
...
import cn.xilio.ql.admin.util.CommonUtil;
...
public class UserController extends BaseController {
	...
	public Page<User> list(PageReq page, String searchText){
		Page<User> info = userService.pageUser(page, param(searchText));
		return info;
	}
