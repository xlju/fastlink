package cn.xilio.ql.admin.util;


import cn.xilio.ql.admin.common.domain.vo.HotKeyLineChartVo;
import cn.xilio.ql.admin.model.Statistics;
import cn.xilio.ql.admin.model.Summary;
import cn.xilio.ql.framework.tool.Constant;
...
public class CommonUtil {
    ...
    public static Summary buildSummary(String key, Map<String, String> map) {
        String[] args = key.split( Constant.BAK_DELIMITER);
        String app = args[0];
        String rule = args[1];
